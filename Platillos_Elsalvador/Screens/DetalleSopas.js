  ...
  return (
    <ScrollView contentContainerStyle={styles.scrollView}>
      <View style={styles.container}>
        <Text style={styles.heading}>{tip.Nombre}</Text>
        <Image source={{ uri: tip.Foto }} style={styles.imagen} />
        <Text style={styles.tipTitle}>Descripción</Text>
        <Text style={styles.TextPais}>{tip.Descripcion}</Text>
        <Text style={styles.tipTitle}>Precio</Text>
        <Text style={styles.TextPais}>${tip.Precio}</Text>
        <Text style={styles.tipTitle}>Ingredientes</Text>
        <View style={styles.tipContainer}>
          {tip.Ingredientes.map((tip, tipIndex) => (
